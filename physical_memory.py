...
class PhysicalMemory:
    def __init__(self, physical_memory_mb, percent_memory_used):
        ...
        self.total_ram_page_table_bytes = self.num_physical_pages * (self.size_page_table_entry_bits / 8)  # Convert bits to bytes
